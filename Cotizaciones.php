 ...
 <font FACE="Comic Sans MS"><li><a href="index.php">Inicio</a></li>
        ...
        <div class="section" id="features">
            <div class="layout layout-right">
                <div class="image">
                    <img src="img/cotizacion.png" width="500" >
                </div>
                <div class="text">
                    <h3>Cotizacion Online</h3>
                    <form action="formulario.php" method="post" enctype="multipart/form-data" name="form1"> 
                        <table width="100%" border="0">
                        <h4 align="justify">Rellena los campos en blanco, los campos marcado con (*) son Obligatorios.</h4><br>
                        <tr> 
                        ...
                        <tr> 
                        <td><div align="right">Articulo a Cotizar:(*)</div></td>
                        <td><input name="mail" type="text" id="mail" maxlength="50"></td> 
                        </tr> 
                        <tr> 
